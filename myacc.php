...
<ul class="nav nav-pills">
        ...
        <li  class="active"><a href="./myacc.php">Account Balance</a></li>
       </ul>
...
echo "<h2>My Budget:</h2>".$row3["bud"]."$<br>";}

?>

<?php
$uname=$_SESSION["uname"];
$sql = "SELECT bid,bname,doi FROM orders Where uname='$uname'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
echo "<h2>My Books:</h2><table class=table style=width:100>
<tr>
...
echo "<tr><th>".$row["bid"]."</th><th>".$row["bname"]."</th><th>".$row["doi"]."</th></tr>";}
